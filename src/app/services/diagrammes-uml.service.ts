    ...
    diagrammesUmls: DiagrammeUml[] = [
        {
            ...
            imageUrl: "/assets/Diagramme-De-Temps.png",
        },
        {
            id: 2,
        ...
        },
        {
            ...
            content : ": 1. Acteurs : Les acteurs sont des entités externes au système qui interagissent avec lui. Ils sont représentés par des formes ovales ou des boîtes de texte situées en haut du diagramme. Chaque acteur peut être nommé et avoir un rôle spécifique.<br/><br/> 2. Objets : Les objets sont les instances de classes ou d'entités du système qui participent aux interactions. Ils sont représentés par des rectangles situés sous les acteurs. Chaque objet peut être nommé et indiquer sa classe d'appartenance.<br/><br/> 3. Lignes de communication : Les lignes de communication sont des flèches oudes lignes pleines qui connectent les acteurs aux objets et les objets entre eux. Elles représentent les messages ou les informations échangés lors des interactions.<br/><br/> 4. Messages : Les messages sont des étiquettes le long des lignes de communication qui décrivent les actions ou les interactions entre les acteurs et les objets. Les messages peuvent être synchrones (bloquants) ou asynchrones (non bloquants).<br/><br/> 5. Rôles : Les rôles sont des labels optionnels attribués aux obiets pour préciser leur fonction dans une interaction spécifique. Ils sont souvent utilisés pour montrer comment différents objets collaborent pour accomplir une tâche.",
        ...
        },
        {
            ...
            description:"Un diagramme de vue d'ensemble, aussi appelé diagramme de contexte, est un type de diagramme utilisé en ingénierie logicielle et en architecture système pour fournir une représentation simplifiée et globale d'un système ou d'une application. Ce diagramme met en évidence les interactions et les relations principales entre le système étudié et son environnement externe.",
            content: "Système central : Au centre du diagramme se trouve le système ou l'application que vous étudiez. C'est le sujet principal du diagramme, et il est généralement représenté sous forme d'une boîte ou d'un rectangle. <br/><br/>   Acteurs externes : Autour du système central, vous avez des acteurs externes. Ce sont des entités, des personnes, des systèmes ou des composants extérieurs qui interagissent avec le système central d'une manière ou d'une autre. Ils sont généralement représentés sous forme de boîtes ou de formes simples et sont connectés au système central par des lignes ou des flèches pour montrer les interactions.<br/><br/> Interfaces : Les lignes ou les flèches qui relient le système central aux acteurs externes représentent les interfaces ou les points d'interaction entre le système et ces acteurs. Ces interfaces montrent comment les informations, les commandes ou les données circulent entre le système central et les acteurs externes.<br/><br/>L'objectif principal d'un diagramme de vue d'ensemble est de fournir une vue simplifiée et compréhensible des interactions essentielles entre un système et son environnement. Il est souvent utilisé au début d'un projet pour clarifier les interactions de haut niveau et les exigences fondamentales du système, avant de plonger dans des détails plus spécifiques avec d'autres types de diagrammes et de modèles. En résumé, un diagramme de vue d'ensemble vous aide à avoir une vision globale et à comprendre comment un système interagit avec le monde qui l'entoure.",
            imageUrl: "https://webusupload.apowersoft.info/gitmind/wp-content/uploads/2021/05/interaction-diagram-1.jpg",
        },
        {
            id: 6,
            ...
            content: " • Ils simplifient les diagrammes de classes complexes en les  organisant de manière visuelle. <br/><br/> • Ils sont particulièrement utiles pour les projets et systèmes de grande envergure. <br/><br/> • Les diagrammes de paquetages peuvent être utilisés pour clarifier visuellement divers types de proiets et systèmes. <br/><br/> • Ils sont facilement mis à jour pour refléter les changements dans les systèmes et les projets au fil du temps. ",
        ...
        // },
        {
            ...
            description: " Un diagramme de déploiement est un outil de visualisation utilisé en ingénierie logicielle pour montrer comment les différents composants logiciels d'une application sont déployés sur des matériels physiques ou des machines. Il est principalement utilisé pour représenter l'architecture matérielle et logicielle d'un système informatique. " ,
            content:"Nœud : Les nœuds sont des représentations visuelles des matériels physiques ou des machines sur lesquels les logiciels sont exécutés. Par exemple, un nœud peut représenter un ordinateur, un serveur, un routeur, ou même un smartphone.<br/><br/>Artéfact : Les artéfacts représentent les éléments logiciels, tels que des applications, des bases de données, des bibliothèques, ou des composants. Chaque artéfact est généralement lié à un nœud spécifique qui l'exécute.<br/><br/>Lien : Les liens sont des connexions visuelles entre les nœuds et les artéfacts. Ils montrent comment les différents composants logiciels sont déployés sur les matériels physiques. Par exemple, un lien entre un serveur (nœud) et une base de données (artéfact) indique que cette base de données est hébergée sur ce serveur.<br/><br/>Interface : Une interface représente la manière dont les composants communiquent entre eux. Par exemple, un serveur peut avoir une interface de communication avec une base de données pour lire et écrire des données.<br/><br/>En résumé, un diagramme de déploiement vous permet de voir comment les différentes parties d'un système informatique, qu'il s'agisse de matériels physiques ou de logiciels, sont connectées les unes aux autres et où elles sont déployées. Cela aide les concepteurs et les développeurs à comprendre l'architecture du système et à planifier son déploiement physique.",
        ...
        },
        {
            ...
            content:"Voici une explication rapidedes composants clés d'un diagramme de communication :<br/><br/> 1. Acteurs : Les acteurs sont des entités externes au système qui interagissent avec lui. Ils sont représentés par des formes ovales ou des boîtes de texte situées en haut du diagramme. Chaque acteur peut être nommé et avoir unrôle spécifique.<br/><br/> 2. Objets : Les objets sont les instances de classes ou d'entités du système qui participent aux interactions. Ils sont représentés par des rectangles situés sous les acteurs. Chaque objet peut être nommé et indiquer sa classe d'appartenance. <br/><br/>3. Lignes de communication : Les lignes de communication sont des flèches oudes lignes pleines qui connectent les acteurs aux objets et les objets entre eux. Elles représentent les messages ou les informations échangés lors desinteractions.<br/><br/> 4. Messages : Les messages sont des étiquettes le long des lignes de communication qui décrivent les actions ou les interactions entre les acteurs et les objets. Les messages peuvent être synchrones (bloquants) ou asynchrones(non bloquants).<br/><br/> 5. Rôles : Les rôles sont des labels optionnels attribués aux objets pour préciser leur fonction dans une interaction spécifique. Ils sont souvent utilisés pour    montrer comment différents objets collaborent pour accomplir une tâche.",
        ...
        },
        {
            ...
            content:"Voici une explication rapide des composants clés d'un diagramme d'état :<br/><br/> 1. États : Les états représentent les situations ou les conditions dans lesquelles un objet ou une entité peut se trouver. Ils sont généralement représentés par des rectangles avec des noms à l'intérieur. <br/><br/>2. Transitions : Les transitions sont des flèches qui relient les états et indiquent comment l'objet passe d'un état à un autre en réponse à des événements ou des conditions spécifiques. <br/><br/>3. Événements : Les événements sont des déclencheurs qui provoquent des transitions entre les états. Ils sont représentés à côté des flèches de transition et peuvent inclure des conditions qui doivent être satisfaites pour que la transition se produise. <br/><br/>4. Actions : Les actions sont des opérations ou des comportements associés à un état ou une transition. Elles sont généralement spécifiées sous forme de texte à l'intérieur des états ou à côté des transitions. <br/><br/>5. État initial : Il s'agit de l'état dans lequel l'objet se trouve au moment de sa création ou du début de son cycle de vie. Il est généralement indiqué par une flèche entrante spéciale.<br/><br/> 6. État final : C'est l'état qui marque la fin du cycle de vie de l'obiet. Il est généralement représenté par un cercle avec un point à l'intérieur.<br/><br/>En utilisant ces éléments, un diagramme d'état permet de modéliser comment un objet réagit aux événements et aux conditions en passant d'un état à un autre, ce qui est essentiel pour comprendre et spécifier le comportement d'un système logiciel ou matériel. ",
