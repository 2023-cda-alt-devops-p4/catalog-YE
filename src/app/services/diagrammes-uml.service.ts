...
export class DiagrammeUmlsService{
    ...
    diagrammesUmls: DiagrammeUml[] = [
        ...
        },
        {
            ...
            description: "Ils offrent une vue hiérarchique précise de la structure deséléments UML au sein d'un système. • Ils simplifient les diagrammes de classes complexes en les  organisant de manière visuelle. • Ils sont particulièrement utiles pour les projets et systèmes de grande envergure. • Les diagrammes de paquetages peuvent être utilisés pour clarifier visuellement divers types de proiets et systèmes. • Ils sont facilement mis à jour pour refléter les changements dans les systèmes et les projets au fil du temps. ", 
            imageUrl: "",
        },
        {
            id: 7,
        ...
        },
        {
            ...
            description: " Un diagramme de profil en UML est utilisé pour définir et personnaliser de nouveaux éléments, des stéréotypes, des types d'éléments, des contraintes et d'autres métadonnées pour étendre le langage UML de base. Ces profils permettent d'adapter UML à des domaines spécifiques ou à des besoins particuliers dans un projet. Voici comment fonctionne un diagramme de profil en UML :  <br/><br/>Éléments clés d'un diagramme de profil : <br/><br/> 1. Éléments UML de base : Un diagramme de profil utilise les éléments UML de base, tels que les classes, les associations, les packages, etc., comme point de départ pour la création de profils.<br/><br/> 2. Stéréotypes :Les stéréotypes sont des étiquettes spéciales qui sont appliquées aux éléments UML de base pour indiquer qu'ils sont associés à un profil particulier. Les stéréotypes permettent de marquer les éléments en fonction de leur rôle dans le profil.<br/><br/>3. Types d'éléments : Les types d'éléments définissent de nouveaux types spécifiques au profil, par exemple, de nouvelles classes, associations ou objets d'activité.<br/><br/> 4. Contraintes : Les contraintes peuvent être utilisées pour définir des règles ou des conditions spécifiques aux éléments du profil.<br/><br/>Utilisation :<br/><br/>Les diagrammes de profil en UML sont utilisés pour personnaliser le langage UML afin qu'il corresponde aux besoins spécifiques d'un projet ou d'un domaine d'application. Les profils sont particulièrement utiles pour ajouter des métadonnées, des règles de validation et des conventions de modélisation spécifiques à un projet.<br/><br/> " ,
        ...
        },
        {
            ...
            description: "Modèle Conceptuel de Données représente les entités, leurs attributs et leurs associations dans un système d'information. " ,
            imageUrl: " ",
        },
        {
            id: 16,
            ...
            description: " Modèle Conceptuel de Traitement modélise les processus métier et les flux d'information entre eux. " ,
            imageUrl: " ",
        },
        {
            id: 17,
            ...
            description: " Modèle Conceptuel de Communication montre les interactions entre les acteurs (utilisateurs) du système et les processus métier." ,
            imageUrl: " ",
        },
        {
            id: 18,
            ...
            description: " Modèle Organisationnel de Données spécifie la manière dont les données sont stockées et organisées dans le système, notamment les tables de bases de données et leurs relations. " ,
            imageUrl: " ",
        },
        {
            id: 19,
            ...
            description: " Modèle Organisationnel de Traitement définit la façon dont les tâches et les activités sont organisées au sein de l'entreprise, y compris les acteurs responsables de chaque activité. " ,
            imageUrl: " ",
        },
        {
            id: 20,
            ...
            description: " Diagramme de Flux de Données représente les flux de données entre les processus, les entités externes et les entrepôts de données. " ,
            imageUrl: " ",
        },
        {
            id: 21,
            ...
            description: " Diagramme de Flux de Contrôle détaille la séquence des étapes dans un processus ou une fonction. " ,
            imageUrl: " ",
        },
        {
            id: 22,
            ...
            description: " Diagramme d'Architecture des Systèmes d'Information montre la structure générale du système d'information, y compris les composants matériels et logiciels. " ,
            imageUrl: " ",
        },
        {
            id: 23,
            ...
            description: " Diagramme de Flux d'Architecture identifie les flux d'information à travers le système. " ,
            imageUrl: " ",
        },
        {
            id: 24,
            ...
            description: " Diagramme d'Architecture des Organisations décrit la structure organisationnelle de l'entreprise et les rôles des différents acteurs. " ,
            imageUrl: " ",
        },
        {
            id: 25,
